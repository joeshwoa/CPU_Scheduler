...
public class AG_Scheduling {
    ...
    private void PrintProcessDataThatRunCaseII (int p_num)
    {
        ...
        System.out.println("burst time ="+processes[p_num].burst_time);
        System.out.println("quantum time = "+processes[p_num].ag_quantum +" + ceil(remaining_quantum) = ");
        ...
        System.out.println("quantum time = "+processes[p_num].ag_quantum +" + "+half_of_remaining_quantum+" = "+(processes[p_num].ag_quantum+half_of_remaining_quantum) );
    }
    private void PrintProcessDataThatRunCaseIII (int p_num)
    {
        ...
        System.out.println("quantum time = "+processes[p_num].ag_quantum +" + "+remaining_quantum+" = "+(processes[p_num].ag_quantum+remaining_quantum) );
    }
    public void Print()
    {
